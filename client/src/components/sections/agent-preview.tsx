...
export default function AgentPreview() {
  ...
  return (
    <section className="py-24 bg-gradient-to-br from-background via-background to-foreground/5 relative overflow-hidden" data-testid="agent-preview-section">
      {/* Decorative Elements */}
      <div className="absolute top-0 -right-32 w-96 h-96 bg-secondary/5 rounded-full blur-3xl"></div>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative">
        <div className="text-center mb-20">
          ...
          <h2 className="text-5xl lg:text-6xl font-black text-foreground mb-6 tracking-tight" data-testid="text-team-preview-title">
            Meet Our Expert Team
          </h2>
          <p className="text-lg text-muted-foreground max-w-3xl mx-auto leading-relaxed" data-testid="text-team-preview-description">
            Our certified tax professionals bring decades of combined experience to help you achieve your financial goals.
          </p>
        </div>

        <div className="grid md:grid-cols-2 lg:grid-cols-2 gap-12 mb-16 lg:max-w-4xl lg:mx-auto">
            {previewAgents.map((agent, index) => (
              ...
              >
                ...
                {/* Card */}
                <div className="relative bg-card border-2 border-border/50 rounded-2xl overflow-hidden hover:border-primary/30 transition-all duration-500 hover:shadow-2xl backdrop-blur-sm">
                  {/* Image Container */}
                  <div className="relative overflow-hidden h-72 lg:h-80">
                    ...
                    {/* Premium Badge */}
                    <div className="absolute top-4 right-4 bg-white/95 backdrop-blur-md rounded-full px-4 py-2 flex items-center gap-2 shadow-lg">
                  ...
                  {/* Content */}
                  <div className="p-8">
                    <h3 className="text-2xl font-bold mb-2 group-hover:text-primary transition-colors duration-200 tracking-tight" data-testid={`text-preview-agent-name-${index}`}>
                      {agent.name}
                    </h3>
                    <p className="text-primary font-bold mb-4 text-lg" data-testid={`text-preview-agent-title-${index}`}>
                      {agent.title}
                    </p>
