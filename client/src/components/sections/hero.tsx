...
export default function Hero() {
  ...
  return (
    <section className="hero-gradient text-white py-10 md:py-32 lg:py-40 relative overflow-hidden md:min-h-screen" data-testid="hero-section">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative">
        <div className="grid lg:grid-cols-2 gap-8 md:gap-16 items-center">
          <div className="text-center lg:text-left pt-2 md:pt-0 relative">
            ...
            <div className="md:hidden mb-8 flex flex-col items-center">
              <div className="relative w-full max-w-sm">
                ...
                <img 
                  ...
                  className="rounded-2xl shadow-2xl w-full h-60 object-cover object-[50%_60%] sm:object-center relative"
              ...
              {/* Trust stats (moved out of image overlay on mobile) */}
              <div className="mt-4 w-full max-w-sm grid grid-cols-2 gap-3" data-testid="hero-mobile-stats">
                <div className="bg-white/95 text-gray-900 rounded-xl px-4 py-3 shadow-lg border border-white/20">
                  <div className="text-lg font-black text-primary leading-none">$2.5M+</div>
                  <div className="text-xs font-semibold text-gray-600 mt-1">Refunds Secured</div>
                </div>
                <div className="bg-white/95 text-gray-900 rounded-xl px-4 py-3 shadow-lg border border-white/20">
                  <div className="text-lg font-black text-secondary leading-none">99%</div>
                  <div className="text-xs font-semibold text-gray-600 mt-1">On-Time Filing</div>
                </div>
              </div>
            </div>
            ...
            <p className="text-base md:text-lg lg:text-2xl mb-6 md:mb-8 opacity-90 leading-relaxed animate-in fade-in slide-in-from-bottom-4 duration-700 delay-150" data-testid="text-hero-description">
              <span className="block sm:inline">Professional tax preparation and planning</span>{" "}
              <span className="block sm:inline">designed to maximize your refund</span>{" "}
              <span className="block sm:inline">and reduce stress.</span>
            </p>
            ...
            <div className="flex flex-col md:flex-row md:items-center md:space-x-8 mb-6 md:mb-8 justify-center lg:justify-start gap-4 md:gap-0">
              <div className="flex items-center">
                <CheckCircle className="h-5 w-5 md:h-5 md:w-5 mr-2 text-green-300 flex-shrink-0" />
                <span className="text-xs md:text-sm"><span className="font-bold">Maximum Refund Guarantee</span></span>
              </div>
              <div className="flex items-center">
                <CheckCircle className="h-5 w-5 md:h-5 md:w-5 mr-2 text-green-300 flex-shrink-0" />
                <span className="text-xs md:text-sm"><span className="font-bold">Year-Round Support</span></span>
              </div>
            </div>
            
            <div className="flex flex-col gap-2 w-full md:w-auto md:flex-row justify-center lg:justify-start animate-in fade-in slide-in-from-bottom-6 duration-700 delay-200">
              <div className="w-full md:w-auto">
                <Link href="/appointments" data-testid="link-get-started" className="block w-full md:w-auto">
                  <Button className="bg-gradient-to-r from-yellow-300 via-yellow-200 to-orange-300 text-gray-900 px-6 md:px-8 py-4 md:py-4 rounded-xl font-extrabold hover:from-yellow-200 hover:via-yellow-200 hover:to-orange-200 transition-all duration-300 transform hover:scale-[1.03] shadow-[0_18px_40px_-20px_rgba(253,224,71,0.85)] ring-1 ring-white/20 group text-base md:text-lg w-full md:w-auto min-h-[48px]">
                    Book Appointment
              ...
              {/* Secondary CTA as text link (reduces distraction on mobile) */}
              <div className="md:hidden pt-1">
                <Link href="/services" data-testid="link-view-services" className="inline-flex justify-center w-full">
                  <span className="text-sm font-semibold text-white/90 underline underline-offset-4 hover:text-white transition-colors min-h-[44px] flex items-center">
                    View services
                  </span>
                </Link>
              </div>
              ...
              <div className="hidden md:block">
                <Link href="/services" data-testid="link-view-services" className="w-full md:w-auto">
                  <Button variant="outline" className="border-2 border-white/90 text-white bg-transparent px-6 md:px-8 py-3 md:py-4 rounded-xl font-bold md:font-semibold hover:bg-white hover:text-primary transition-all duration-300 transform hover:scale-105 text-base md:text-lg backdrop-blur-sm w-full md:w-auto min-h-[48px]">
                    View Services
                  </Button>
                </Link>
              </div>
