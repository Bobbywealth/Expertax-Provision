    ...
    <div className="min-h-screen bg-background" data-testid="page-home">
      ...
      <div className="fixed top-0 left-0 right-0 z-50 bg-gradient-to-r from-white/95 to-white/90 backdrop-blur-xl border-b border-primary/10 shadow-lg" data-testid="top-bar">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 h-16 flex items-center justify-between">
          <Link href="/" data-testid="link-home" className="group hover:scale-105 transition-transform duration-300">
            <div className="flex items-center space-x-3">
              ...
              <div className="text-2xl font-black bg-gradient-to-r from-primary to-secondary bg-clip-text text-transparent hidden sm:block tracking-tight">Provision ExperTax</div>
            </div>
          </Link>
          
          <Link href="/appointments" data-testid="link-book-appointment">
            <Button className="bg-gradient-to-r from-primary to-primary/80 text-primary-foreground hover:shadow-xl hover:scale-105 shadow-lg font-bold px-8 py-3 rounded-xl transition-all duration-300 group">
              Book Now
